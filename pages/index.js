    ...
    <div className={`relative ${data.showCursor && "cursor-none"}`}>
      ...
      <div className="container mx-auto mb-10">
        ...
        <div className="mt-10 tablet:ml-12 laptop:ml-11 laptopl:ml-11 mobs:ml-4">
          ...
          <div className="mt-1">
            <div class="w-full flex space-x-3 p-10 snap-x snap-mandatory mt-1 md:mt-28 scrollbar-thin overflow-y-hidden overflow-x-scroll scrollbar-track-gray-400/20 scrollbar-thumb-[#F7AB0A]/80">
              <article class="flex flex-col rounded-lg items-center space-y-12 md:space-y-7 flex-shrink-0 w-1/2 snap-start bg-[#292929] p-4 md:p-10 hover:opacity-100 opacity-60 cursor-pointer transition-opacity duration-200 tablet:w-2/4 mob:w-full mobs:w-full">
                <div class="px-2 md:px-10">
                  <h4 class="text-lg md:text-2xl lg:text-4xl font-light">
                  ...
                  <p class="uppercase py-3 md:py-5 text-gray-300">
                    August 2021 - Present{" "}
                  </p>
                  <ul class="list-disc space-y-4 ml-5 text-sm md:text-lg">
                    <li>
        ...
        <div className="mt-10 tablet:ml-12 laptop:ml-11 laptopl:ml-11 mobs:ml-4">
          ...
          <div className="mt-1">
            <div class="flex flex-col space-y-2">
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4 tablet:grid-cols-4">
                <div>
                  <p class="text-gray-300 font-bold">Programming Languages:</p>
                  ...
                  <p class="text-gray-300 font-bold mt-4 ">Databases:</p>
                  <ul class="list-disc space-y-1 pl-4">
                    <li>SQL, Postgres</li>
                    <li>SQLite</li>
                  </ul>
                ...
                <div>
                  <p class="text-gray-300 font-bold">Cloud:</p>
                  <ul class="list-disc space-y-1 pl-4">
        ...
        <div class="mt-10 tablet:ml-12 laptop:ml-11 laptopl:ml-11 mobs:ml-4">
          <h1 className="text-2xl font-bold">Projects</h1>

          <div class="grid grid-cols-1 sm:grid-cols-2 tablet:grid-cols-3 laptop:grid-cols-4 gap-8 max-w-12xl mx-auto lg:gap-x-20 mt-3">
